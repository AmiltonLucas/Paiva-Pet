...
export default function Products() {
  ...
  const racoesRef = useRef(null);
  const petiscosRef = useRef(null);
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        <nav className="flex overflow-x-auto gap-4 px-4 py-2 bg-white scrollbar-hide lg:justify-center">
          <button
          ...
          <button
            onClick={() => scrollToSection(racoesRef, "racoes")}
            className={`text-sm font-medium px-4 py-2 rounded-lg hover:bg-gray-100 ${
              activeSection === "racoes" ? "border-b-2 border-red-500" : ""
            }`}
            style={{ color: COLORS.text }}
          >
            Rações
          ...
          <button
            onClick={() => scrollToSection(petiscosRef, "petiscos")}
            className={`text-sm font-medium px-4 py-2 rounded-lg hover:bg-gray-100 ${
              activeSection === "petiscos" ? "border-b-2 border-red-500" : ""
            }`}
            style={{ color: COLORS.text }}
          >
            Petiscos
      ...
      <main className="px-4 py-6">
        ...
        {/* Brinquedos */}
        <section ref={racoesRef} className="mb-8">
          <h2 className="text-lg font-bold mb-4" style={{ color: COLORS.text }}>
            Rações
          </h2>
          <div className="flex overflow-x-auto gap-4 scrollbar-hide">
        ...
        {/* Acessorios */}
        <section ref={petiscosRef} className="mb-8">
          <h2 className="text-lg font-bold mb-4" style={{ color: COLORS.text }}>
            Petiscos
          </h2>
          <div className="flex overflow-x-auto gap-4 scrollbar-hide">
